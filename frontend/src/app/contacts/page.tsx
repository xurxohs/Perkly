...
export default function ContactsPage() {
  return <main className="public-info-page min-h-screen px-5 py-12 sm:py-16"><div className="mx-auto max-w-5xl">
    <nav aria-label="Хлебные крошки" className="public-info-muted text-sm"><Link href="/" className="public-info-link public-info-breadcrumb-link">Perkly</Link> / Контакты</nav>
